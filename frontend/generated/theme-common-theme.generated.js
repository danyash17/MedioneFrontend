...
import stylesCss from 'themes/common-theme/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_common-theme_componentCss']) {
    
    document['_vaadintheme_common-theme_componentCss'] = true;
  }
